...
import dev.phoenix.app.ui.navigation.PhoenixNavGraph
import dev.phoenix.app.ui.theme.PanTheme
...
class MainActivity : ComponentActivity() {
    ...
    private fun startPanService() {
        val intent = Intent(this, PhoenixForegroundService::class.java)

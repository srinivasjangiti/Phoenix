// Phoenix Dashboard Watchdog — detects stuck/black loading screen and auto-recovers.
//
...
async function captureFrame() {
  // Pass windowId so Tauri crops to the Phoenix window rather than sampling the full

// Phoenix Forge: Dashboard Bug Auto-Fixer — task #508, Layer 5 of self-heal stack.
//
...
const PROJECT_PATH = '%USERPROFILE%\\Desktop\\Phoenix';
...
function buildPrompt(bug) {
  return `You are Phoenix Forge — automated bug-fix system. Today you're fixing a dashboard-render bug detected by the self-heal stack.

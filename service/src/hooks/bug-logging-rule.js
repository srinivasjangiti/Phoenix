#!/usr/bin/env node
/**
 * Phoenix Bug Logging Rule — UserPromptSubmit hook
 *
...
process.stdin.on("end", () => {
  ...
  // Scope: Phoenix project only. Accept both Desktop\Phoenix and OneDrive\Desktop\Phoenix.
  if (!/[\\/]Phoenix([\\/]|$)/i.test(cwd)) {
    process.exit(0);
  }
  ...
  process.stdout.write(
    [
      "",
      "## ⚠️ Phoenix Bug Logging Rule triggered (harness-enforced via .claude/settings.json)",
      "",

// Phoenix Dashboard Vision Verifier — task #507, Layer 4 of dashboard self-heal stack.
//
...
function buildPrompt(widgetNames) {
  ...
  return `You are looking at a screenshot of the Phoenix dashboard. The dashboard is divided into panels.
...
async function scanOnce() {
  ...
  try {
    ...
    try {
      ...
      // "[Phoenix Vision] Ollama minicpm-v:latest failed: The operation was

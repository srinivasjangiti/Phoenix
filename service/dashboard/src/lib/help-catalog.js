/**
 * Phoenix In-App Help Catalog & Knowledge Base
 * 
 * Grounded in documentation/PHOENIX-EXPLAINED.md and documentation/PHOENIX-EXPLAINED-MINI.md.
 * 100% on-device client-side data structure with instant search indexing.
...
export const HELP_CATEGORIES = [
  {
    ...
    icon: '🚀',
    badge: 'Basics',
    summary: 'What is Phoenix, how it differs from normal chatbots, and your first prompt steps.'
  },
  {
    id: 'memory',
    title: 'Memory & Diary',
    icon: '🧠',
    badge: 'Core',
    summary: 'The 3 drawers of memory, how notes are saved, encrypted, and remembered over time.'
  },
  {
    id: 'ai-engines',
    title: 'AI Engines',
    icon: '⚡',
    badge: 'Models',
    summary: 'Local offline AI with Ollama vs Cloud AI, model recommendations, and switching engines.'
  },
  {
    id: 'privacy-senses',
    title: 'Privacy & Senses',
    icon: '🛡️',
    badge: 'Security',
    summary: 'Screen awareness, desk presence, Tailscale private networking, and local data residency.'
  },
  {
    id: 'backup-safety',
    title: 'Backup & Safety',
    icon: '💾',
    badge: 'Safety',
    summary: 'How encryption keys protect your notes and how to backup or restore your memory.'
  },
  {
    id: 'troubleshooting',
    ...
    icon: '🔧',
    badge: 'Remedies',
    summary: 'One-click fixes for sleeping AI engines, missing models, and busy databases.'
  }
];
...
export const HELP_TOPICS = [
  // 1. GETTING STARTED
  {
    ...
    badge: 'Introduction',
    summary: 'A personal AI assistant that lives on your PC and remembers your work instead of having amnesia.',
    keywords: ['phoenix', 'what is', 'amnesia', 'personal ai', 'assistant', 'diary', 'desktop', 'introduction'],
    content: `
...
• **It reaches other devices:** It can talk to your Android phone, other PCs, and smart home lights over a private connection.
  ...
  },
  {
    id: 'body-vs-brain',
    category: 'getting-started',
    title: 'The Brain vs. The Body',
    badge: 'Concepts',
    summary: 'Understanding the relationship between Phoenix and AI models like Gemma, Llama, or Claude.',
    keywords: ['brain', 'body', 'ollama', 'gemma', 'llama', 'claude', 'architecture', 'concept'],
    content: `
...
Without Phoenix, an AI model has no memory and cannot see your computer. Without an AI model, Phoenix could save notes but could not understand or reply in natural language. Together, they form a complete personal assistant.
  ...
  },
  {
    id: 'everyday-prompts',
    category: 'getting-started',
    title: 'Everyday Prompts & Cheatsheet',
    badge: 'Examples',
    summary: 'Practical phrases you can use right now to save facts, search history, and control tasks.',
    keywords: ['prompts', 'examples', 'cheatsheet', 'how to use', 'questions', 'remember', 'recall'],
    content: `
...
• *"Turn on the desk lamp."*
    ...
    action: {
      type: 'navigate',
      label: 'Try a Prompt in Terminal',
      target: '/v2/terminal'
    }
  },
  {
    id: 'three-ways-to-interact',
    category: 'getting-started',
    title: '3 Ways to Talk to Phoenix',
    badge: 'Interfaces',
    summary: 'Chat directly in the desktop app, connect Claude Code via MCP, or speak through your Android phone.',
    keywords: ['interfaces', 'desktop', 'android', 'phone', 'claude code', 'mcp', 'terminal', 'dashboard'],
    content: `
...
3. **Android Companion App:**
   Tap the microphone on your phone while away from your desk. Your phone speaks directly to your PC over a secure private network (Tailscale) with zero open internet ports.
    ...
    action: {
      type: 'navigate',
      label: 'Explore Connected Devices',
      target: '/v2/settings'
    }
  },
  ...
  // 2. MEMORY & DIARY
  {
    ...
    category: 'memory',
    title: 'The 3 Drawers of Memory',
    badge: 'Architecture',
    summary: 'How Phoenix organizes your day into episodic timeline, semantic facts, and procedural skills.',
    keywords: ['memory', 'episodic', 'semantic', 'procedural', 'drawers', 'timeline', 'facts', 'skills'],
    content: `
...
3. **How-To Skills (Procedural Memory):**
   Step-by-step instructions on how to run scripts, restart servers, or control specific smart devices.
    ...
    action: {
      type: 'navigate',
      label: 'View Timeline Data',
      target: '/v2/timeline'
    }
  },
  {
    id: 'sarah-paper-example',
    category: 'memory',
    title: 'Real-Life Story: Sarah’s History Paper',
    badge: 'Case Study',
    summary: 'A step-by-step walkthrough of how Sarah used Phoenix across four days without taking notes.',
    keywords: ['story', 'sarah', 'example', 'case study', 'homework', 'paper', 'recall', 'use case'],
    content: `
**Monday:**
...
Phoenix searches its encrypted memory and replies immediately: *"Your paper is on the Roman Empire and needs 4 sources."* Sarah didn't have to search through old sticky notes, browser history, or chat transcripts.
    ...
    action: {
      type: 'navigate',
      label: 'Ask Phoenix a Question',
      target: '/v2/terminal'
    }
  },
  {
    id: 'how-memory-search-works',
    category: 'memory',
    title: 'How Search & Recall Works',
    badge: 'Deep Dive',
    summary: 'Combining fast keyword searching with mathematical vector embeddings for instant semantic recall.',
    keywords: ['search', 'recall', 'vector', 'embeddings', 'hybrid', 'sqlite-vec', 'fts5', 'keywords'],
    content: `
...
Both results are combined and scored so the most relevant facts are handed to the AI brain before it writes an answer to you.
  ...
  // 3. AI ENGINES
  {
    id: 'local-vs-cloud',
    category: 'ai-engines',
    title: 'Local AI (Ollama) vs. Cloud AI',
    badge: 'Comparison',
    summary: 'Compare free offline local processing with fast cloud intelligence to pick what fits your needs.',
    keywords: ['local', 'cloud', 'ollama', 'privacy', 'offline', 'speed', 'costs', 'comparison'],
    content: `
...
• **Cloud AI (Anthropic / Cerebras / OpenAI):**
  ...
  - *Requirement:* Requires an internet connection and your own API key.
    ...
    action: {
      type: 'navigate',
      label: 'Choose AI Engine in Settings',
      target: '/v2/settings'
    }
  },
  {
    ...
    badge: 'Catalog',
    summary: 'Curated models tested for speed, accuracy, and low memory consumption on Windows.',
    keywords: ['models', 'llama', 'qwen', 'download', 'size', 'ram', 'recommendations', 'local ai'],
    content: `
...
3. **Qwen 2.5 (1.5B) — Balanced Alternative**
  ...
  {
    id: 'strict-local-mode',
    category: 'ai-engines',
    title: 'Strict Local Mode & Zero Cloud Fallback',
    badge: 'Guarantees',
    summary: 'Why Phoenix will never secretly send your private words to cloud servers when set to Local AI.',
    keywords: ['strict', 'privacy', 'no fallback', 'leak', 'guarantee', 'local only', 'cloud leak'],
    content: `
...
• Your local preference is honored as a hard security boundary.
  ...
  {
    id: 'senses-explained',
    category: 'privacy-senses',
    title: 'Senses & Awareness: What Does Phoenix See?',
    badge: 'Privacy',
    summary: 'How active window tracking and desk presence work, and why they exist.',
    keywords: ['senses', 'screen', 'window', 'webcam', 'presence', 'tracking', 'privacy', 'permission'],
    content: `
...
• **Desk Presence (Webcam Glance):**
  ...
  *Privacy:* Raw camera frames are analyzed directly in memory on your PC and **never recorded, saved to disk, or sent anywhere**.
    ...
    action: {
      type: 'navigate',
      label: 'Configure Senses & Permissions',
      target: '/v2/settings'
    }
  },
  {
    id: 'what-leaves-your-computer',
    category: 'privacy-senses',
    title: 'What Leaves Your Computer?',
    badge: 'Audit',
    summary: 'An honest audit of data residency: zero notes uploaded, private mesh networking for phones.',
    keywords: ['network', 'data residency', 'leaves', 'cloud', 'tailscale', 'upload', 'telemetry'],
    content: `
...
• **Phone Companion App:** Connects directly to your PC over your own private encrypted Tailscale network mesh. Your traffic does not route through public web servers.
    ...
    action: {
      type: 'navigate',
      label: 'Inspect Security Settings',
      target: '/v2/settings'
    }
  },
  ...
  // 5. BACKUP & SAFETY
  {
    ...
    title: 'Encrypted Storage & Encryption Keys',
    badge: 'Security',
    summary: 'How SQLCipher and phoenix.key lock your database so no other user or program can read your notes.',
    keywords: ['encryption', 'sqlcipher', 'phoenix.key', 'phoenix.db', 'database', 'key', 'security'],
    content: `
...
• **What this means:** If someone copies your \`phoenix.db\` file without your key, all they see is random unreadable binary garbage. Your private thoughts and notes cannot be read.
  ...
  {
    id: 'backup-and-safeguarding',
    category: 'backup-safety',
    title: 'How to Safeguard & Back Up Your Memory',
    badge: 'Guides',
    summary: 'Step-by-step instructions on protecting your memory database before switching computers or reinstalling.',
    keywords: ['backup', 'restore', 'export', 'safeguard', 'reinstall', 'transfer', 'copy'],
    content: `
...
Install Phoenix, open Settings, and select **Restore from Backup**. All your past chats, memories, and facts will be restored instantly.
  ...
  {
    id: 'troubleshoot-ollama-sleeping',
    category: 'troubleshooting',
    title: 'Fix: "Local AI Engine is Sleeping"',
    badge: 'One-Click Fix',
    summary: 'What to do when Ollama is not running on your computer and how to wake it up in 1 click.',
    keywords: ['econnrefused', 'sleeping', 'ollama', 'wake up', 'start', 'troubleshoot', '11434', 'offline'],
    content: `
**What Happened:**
...
• Alternatively, open your Windows Start Menu and launch **Ollama** manually.
    ...
    action: {
      ...
      target: '/api/v1/ollama/start'
    }
  },
  {
    id: 'troubleshoot-model-missing',
    category: 'troubleshooting',
    title: 'Fix: "AI Model Needs Download"',
    badge: 'One-Click Fix',
    summary: 'Resolve missing local models when Ollama returns error 404.',
    keywords: ['404', 'model not found', 'download', 'pull', 'missing', 'llama3.2', 'fix'],
    content: `
**What Happened:**
...
• Once the download reaches 100%, your local assistant is immediately ready to chat.
    ...
    action: {
      type: 'api_call',
      label: 'Download Default Model (llama3.2:1b)',
      target: '/api/v1/ollama/pull',
      body: { model: 'llama3.2:1b' }
    }
  },
  {
    id: 'troubleshoot-database-busy',
    category: 'troubleshooting',
    title: 'Fix: "Memory is Saving Notes"',
    badge: 'Explanation',
    summary: 'Understanding brief SQLITE_BUSY moments when Phoenix is saving multiple notes at once.',
    keywords: ['sqlite_busy', 'database locked', 'busy', 'retry', 'saving notes', 'slow'],
    content: `
**What Happened:**
...
• If an error card appears in the chat bubble, simply click **[Try Again]**.
  ...
  },
  {
    ...
    category: 'troubleshooting',
    title: 'Fix: "Port in Use by Another Program"',
    badge: 'Diagnostic',
    summary: 'Resolving port conflicts when another application occupies port 7777.',
    keywords: ['port', 'eaddrinuse', '7777', 'conflict', 'port in use', 'network'],
    content: `
**What Happened:**
...
export const HELP_FAQS = [
  {
    q: 'Do I need to know how to code to use Phoenix?',
    a: 'No, absolutely not. You can chat or type to Phoenix just like any messaging app. All computer commands, notes, and searches happen in natural language.'
  },
  {
    q: 'Does Phoenix remember after I turn off my computer?',
    a: 'Yes. All memories, facts, and timelines are permanently saved to your encrypted local database file on your hard drive and reload automatically when you turn your PC back on.'
  },
  {
    q: 'Can someone steal or read my personal notes?',
    a: 'Your database is locked with high-grade SQLCipher encryption using a unique encryption key (phoenix.key). Without the key, the file is unreadable scramble.'
  },
  {
    q: 'Does Phoenix replace Windows or change my operating system?',
    a: 'No. Phoenix runs quietly as a friendly assistant app inside Windows, just like Spotify or Word.'
  },
  {
    q: 'Can I use Phoenix completely offline without internet?',
    a: 'Yes! When you configure Phoenix to use Local AI (Ollama), you can unplug your internet connection and Phoenix will still recall your notes and chat with you.'
  },
  {
    q: 'How do I stop or shut down Phoenix?',
    a: 'You can exit Phoenix anytime from the Settings menu or close the application window from your taskbar.'
  }
];

/**
 * Multi-field keyword search across help topics.
 * Executes 100% on-device in <5ms.
 * 
 * @param {string} query - Raw search query
 * @param {string} [categoryId] - Optional category filter
 * @returns {Array<object>} Ranked matching topics
 */
export function searchHelp(query = '', categoryId = 'all') {
  const normalizedQuery = (query || '').trim().toLowerCase();
  
  // Filter by category first if specified
  let topics = HELP_TOPICS;
  if (categoryId && categoryId !== 'all') {
    topics = topics.filter(t => t.category === categoryId);
  }

  // If no query string, return all topics in the filtered category
  if (!normalizedQuery) {
    return topics;
  }
  ...
  const scored = topics.map(topic => {
    ...
    for (const token of queryTokens) {
      // Direct title match (highest relevance)
      if (titleLower.includes(token)) score += 10;
      
      // Keywords match
      if (keywords.some(k => k.toLowerCase().includes(token))) score += 6;
